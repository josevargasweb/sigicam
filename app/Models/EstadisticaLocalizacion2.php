...
class EstadisticaLocalizacion2 extends Estadistica{
    ...
    public function total()
    {
    	...
    	for($i=0;$i<count($categorias);$i++)
    	{
    		...
    		$sql=DB::select(DB::raw("select i.fecha from casos as c,infecciones as i,iaas as ia where ia.id_infeccion=i.id and ia.localizacion='Infeccion del tracto urinario' and ia.procedimiento_invasivo='Cateter Urinario Permanente' and i.caso=c.id and i.fecha >= '".$categorias[$i]."-01' AND i.fecha <'$fecha_siguiente' $sqlest"));
