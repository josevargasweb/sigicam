...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'Archivo no soportado',
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            */
            'script_url' => storage_path(),
            'upload_dir' => storage_path().'/data/documentosDerivacionesCaso/',
            'upload_url' => storage_path().'/data/documentosDerivacionesCaso/',
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|docx|pdf|doc)$/i',
