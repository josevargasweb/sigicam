...
<li><a href="#" onclick='location.reload()'>Editar Producto</a></li>
@stop
...
<script>
    $(function() {
        ...
        $("#formEditarProducto").bootstrapValidator({
			fields: {
                nombre_producto:{
 			 		validators:{
 			 			notEmpty: {
            ...
            var $button = $form.data('bootstrapValidator').getSubmitButton();
 			$.ajax({
 				url: "{{URL::to('administracion/actualizarDatosProducto')}}",
 				type: "post",
 				dataType: "json",
 				data: $form .serialize(),
...
@section("section")
    ...
    <br>
    {{ Form::open(array( 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'formEditarProducto')) }}
		...
		<div class="panel panel-default" >
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        {{ Form::select('visible_producto', array( true => 'Si', false => 'No'), 
                            $producto->visible, array('id' => 'visible_producto', 'class' => 'form-control')) }}
                    </div>
                </div>
                <div class="form-group">
                    <label for="rut" class="col-sm-2 control-label">Código: </label>
                    <div class="col-sm-4" style="width: 490px;">
                        {{Form::text('codigo_producto', $producto->codigo, array('id' => 'codigo_producto', 'class' => 'form-control'))}}
                    </div>
                </div>
                <div class="form-group">
                    <label for="nombres" class="col-sm-2 control-label">Nombre: </label>
                    <div class="col-sm-4">
                        {{Form::text('nombre_producto', $producto->nombre, array('id' => 'nombre_producto', 'class' => 'form-control'))}}
                    </div>
                </div>
                <div class="form-group">
               ...
               {{--  <div id="divEstab" class="form-group">
                    ...
                    <div class="col-sm-4">
                        {{ Form::select('tipo_producto', array( 'medicamento' => 'Medicamento' ,'insumo' => 'Insumo', 'suero' => 'Suero'), $producto->tipo, array('class' => 'form-control', 'id' => 'tipo_proucto')) }}
                    </div>
                </div> --}}
