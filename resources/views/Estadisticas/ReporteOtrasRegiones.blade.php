...
@section("titulo")
Pacientes otras regiones
@stop

@section("miga")
<li><a href="#">Estadisticas</a></li>
<li><a href="#" onclick='location.reload()'>Reporte pacientes otras regiones</a></li>
@stop
    ...
    table = $('#tablaDocDer').dataTable({ 
        dom: 'Bfrtip',
			buttons: [
        		{
					extend: 'excelHtml5',
					messageTop: 'Reporte de pacientes de otras regiones ('+fechaExport+')',
					exportOptions: {
        ...
        "bJQueryUI": true,
        "ajax": {
                "url": "{{asset('estadisticas/otrasRegionesDatos')}}",
...
<br>
<legend>Pacientes otras regiones</legend>
<br>
<!-- <div class="row">
    <div class="col-sm-12">
