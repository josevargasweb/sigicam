    ...
    <body>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="font-size: 30px;" class='azulMarino' colspan="2" rowspan="2">NOCHE</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class='azulMarino'>{{$ueh_2_adulto}}</td>
                        <td class='azulMarino'>{{$ur_2_adulto}}</td>
                        <td class='azulMarino'>{{$ip_2_adulto}}</td>
                        <td style="background-color: #203864; color: #FFF;">{{$it_ueh_2_adulto}}</td>
                    ...
                    <tr>
                        ...
                        <td class='azulMarino'>{{$ueh_2_pediatria}}</td>
                        <td class='azulMarino'>{{$ur_2_pediatria}}</td>
                        <td class='azulMarino'>{{$ip_2_pediatria}}</td>
                        <td style="background-color: #203864; color: #FFF;">{{$it_ueh_2_pediatria}}</td>
                        <td class='azulMarino'></td>
                    </tr>
                    <tr>
                        ...
                        <td class='azulMarino'>{{$ueh_2_adulto + $ueh_2_pediatria}}</td>
                        <td class='azulMarino'>{{$ur_2_adulto + $ur_2_pediatria}}</td>
                        <td class='azulMarino'>{{$ip_2_adulto + $ip_2_pediatria}}</td>
                        <td style="background-color: #203864; color: #FFF;">{{$it_ueh_2_adulto + $it_ueh_2_pediatria}}</td>
                        <td class='azulMarino'></td>
                    </tr>
                </tbody>
            </table>
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="background-color: #ffc000; color: #000;">{{$camasBasicasDos}}</td>
                        <td style="background-color: #ffc000; color: #000;">TOTAL CAMA CRÍTICA DISPONIBLE</td>
                        <td style="background-color: #ffc000; color: #000;">{{$camasCriticasDos}}</td>
                        <td style="background-color: #ffc000; color: #000;">NÚMERO TOTAL PACIENTES ESPERANDO CAMA</td>
                        <td style="background-color: #ffc000; color: #000;">{{$pacientesEsperaDos}}</td>
        ...
        <div class="row">
            <table id="as">
                ...
                <tbody>
                    @foreach($responseNoche["transito"] as $n)
                        <tr>
        ...
        <div class="row">
            <table id="as">
                ...
                <tbody>
                    @foreach($responseNoche["hospitalizados"] as $n)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$n["origen"]}}</td>
                            <td>{{$n["servicioDestino"]}}</td>
        ...
        <div class="row">
            <table id="as">
                ...
                <tbody>
                    @foreach($responseNoche["traslados"] as $n)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$n["origen"]}}</td>
                            <td>{{$n["servicioDestino"]}}</td>
