...
<script>
	...
	// }	
	function mostrarDetalleOtras(){
		otras = document.getElementById("divMorbido");
	...
	// 		var value=$(this).val();
	// 		if(value == "MorbidoOtros")$("#divMorbido").show("slow");
	// 		else $("#divMorbido").hide("slow");
	// 	});
	// });
...
var deleteOtro = function(link){
	...
	$(function(){
		...
		$("#fechaIngreso").datetimepicker({
			...
			$('#formInfeccion').bootstrapValidator('revalidateField', 'fechaIngreso');
		});
		...
		// 	}) //;
		// 	.on("dp.change", function(){ 
		// 	$('#formInfeccion').bootstrapValidator('revalidateField', 'fechaIngreso2');
		// });
		...
		$("#fechaNac").datepicker({
			...
			$('#formInfeccion').bootstrapValidator('revalidateField', 'fechaNac');
		});
		...
		// 					window.location.href="{{URL::to('/')}}/unidad/<?php echo $Miunidad;?>";
		 ...
		 $("#aislamiento").on("change", function(){
			var value=$(this).val();
		 ...
		 //ingresarinfeccion
		// $("#formInfeccion")
		// .find('[name="aislamiento"]')
		// .selectpicker()
		// .change(function(e){
		// 	$("#formInfeccion").bootstrapValidator('revalidateField', 'aislamiento');
		// }).end()
		...
		@endif
			<div class="row">
				...
				<div class="form-group col-md-6">
						...
						<div class="col-sm-6">
				            <select id="aislamiento" name="aislamiento[]" class="selectpicker" multiple placeholder= "Seleccione una o mas"> 
				             <option value="Sin aislamiento">Sin aislamiento</option>
				             <option value="Contacto">Contacto</option>
				             <option value="Aereo">Aereo</option> 
				             <option value="Por gotitas">Por gotitas</option>  
				            </select>
						</div>
				</div>
				{{-- <div class="form-group col-md-6">
					...
					<div class="col-sm-10">
						{{Form::text('fechaIngreso2', null, array('id' => 'fechaIngreso2', 'class' => 'form-control'))}}
					</div>
				</div> --}}
				<div class="row">
					<div class="form-group col-md-6">
		...
		<legend>ANTECEDENTES MORBIDOS</legend><br>
					<div class="form-group col-xs-6 col-sm-6 col-md-9">
						...
						<div class="col-sm-9">
							...
							<label> <input name="morbidos[]" id="check" type="checkbox" value="MorbidoOtros" onchange="javascript:mostrarDetalleOtras()"/> Otras</label>
						</div>
					</div>
					<div id="divMorbido" style="display: none;" class="form-group col-xs-6 col-sm-6 col-md-9">
...
<!-- Fin pestaña Motivo de notificacion -->
