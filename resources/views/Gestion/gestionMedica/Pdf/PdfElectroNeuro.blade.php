	...
	<body>
		...
		<div class="col col_100">
			...
			<div class="col col_50">
				<label>Categoría de prioridad:</label>
				<div>
					<input type="checkbox" @if($datos->extremidades_superiores) checked @endif>emg-ng extremidades superiores<br>
					<input type="checkbox" @if($datos->extremidades_inferiores) checked @endif>test extremidades inferiores<br>
					<input type="checkbox" @if($datos->facial) checked @endif>test Facial<br>
					<input type="checkbox" @if($datos->cuatro_extremidades) checked @endif>test 4 extremidades<br>
					<input type="checkbox" @if($datos->test_estimulacion) checked @endif>test de estimulacion repetitiva<br>
				</div>
			</div>
		</div>
	</body>
